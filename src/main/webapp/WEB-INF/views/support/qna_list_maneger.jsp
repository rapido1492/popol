...
<  											<c:forEach var="qna_list" items="${ qna_list }">
												<tr class="krow2" style="background-color: black;">
													<td class="kcol-first"
														style="text-align: center; width: 80px">${qna_list.qna_idx }</td>
													<td class="kcol-mid"
														style="text-align: center; width: 80px">${qna_list.qna_category }</td>
													<td class="kcol-mid" style="width: 480px"><a
														href="qna_post.do?qna_idx=${ qna_list.qna_idx }&page=${page}">${qna_list.qna_title }</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
